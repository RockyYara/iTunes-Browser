...
class OfflineItemsViewController: UIViewController {
    ...
    private func refreshItems() {
        ...
        OfflineDataManager.sharedInstance.loadItems(of: itemType)
        
        tableView.reloadData()
        
        if OfflineDataManager.sharedInstance.items.count > 0 {
...
extension OfflineItemsViewController: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return OfflineDataManager.sharedInstance.items.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let item = OfflineDataManager.sharedInstance.items[indexPath.row]
